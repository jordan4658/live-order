...
import com.caipiao.live.common.model.vo.lottery.LhcPhotoListVO;
...
public interface LhcLotterySgService {
	 ...
	 * @return
	 */
	ResultInfo<List<List<MapStringVO>>> lhcInfoF(String type, String year, Integer sort, Integer pageNo,
                                                 Integer pageSize);
	 ...
	 * @return
	 */
	ResultInfo<Map<String, Object>> startlottoDate(String date);
	 ...
	 * @return
	 */
	ResultInfo<List<LhcLskjVO>> lhcWebLskj(String year);
	 ...
	 * @return
	 */
	LhcHandicap selectNextHandicap(String issue);
	 ...
	 * 获取六合彩动画开奖信息
	 * 
	 * @param message 期号，状态信息
	 * @param
	 * @return
	 */
	Map<String, Object> getLhcKaijiangMessage(String message);
